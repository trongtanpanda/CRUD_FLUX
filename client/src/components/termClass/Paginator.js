        ...
        return (
            <nav>
                <ul className={'pagination ' + className}>
                	<li className={s.currentPage === 1 ? 'hidden' : ''}>
                        <a href="#/termclass" onClick={this.onClickFirst}>
                            <span aria-hidden="true">First</span>
                            <span className="sr-only">Prev</span>
                        </a>
                    </li>
                    <li className={s.currentPage === 1 ? 'disabled' : ''}>
                        <a href="#/termclass" onClick={this.onClickPrev}>
                    ...
                    {iterator.map(function(page) {
                        return (
                            <li key={page}
                                ...
                                <a href="#/termclass">{page}</a>
                            </li>
                        );
                    }, this)}
                    <li className={s.currentPage === p.max ? 'disabled' : ''}>
                        <a href="#/termclass" onClick={this.onClickNext}>
                            <span aria-hidden="true">&raquo;</span>
                            <span className="sr-only">Next</span>
                        </a>
                    </li>
                    <li className={s.currentPage === p.max ? 'hidden' : ''}>
                        <a href="#/termclass" onClick={this.onClickLast}>
