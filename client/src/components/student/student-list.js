        ...
        var studentList = this.props.students.map(function(student, index) {
            ...
            return (
                <tr key={index}>
                    ...
                    <td className="col-md-1"><input type="button" data-toggle="modal" data-target="#myModal" value="delete" className="btn btn-danger" onClick={StudentActions.deleteStudent.bind(null,student._id)} /></td>
                </tr>
            );
        }.bind(this));
